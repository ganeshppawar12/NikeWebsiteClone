...
const AlwaysIconic = () => {
  ...
  return (
    ...
    <div className='AlwaysIconicContainer'>
        <button className='AlwaysBtn' ><ArrowBackIosNewIcon onClick={handelBackword}></ArrowBackIosNewIcon></button>
        {
        ...
        <button className='AlwaysBtn2' ><ArrowForwardIosIcon onClick={handelForward} ></ArrowForwardIosIcon></button>
